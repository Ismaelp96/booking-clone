  ...
  return (
    <header className='bg-[#013B94]'>
      ...
      >
        ...
        <div className='flex lg:hidden'>
          <button
            ...
            className='-m-2.5 inline-flex items-center justify-center roundeed-md p-2.5 text-white'
          >
              ...
              <Popover.Panel className='absolute bg-white -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl shadow-lg ring-1 ring-gray-900/5'>
                <div className='p-4'>
                  {products.map((item) => (
                    <div
                      key={item.name}
                      className='group relative flex items-center gap-x-6 roundend-lg p-4 text-sm leading-6 hover:bg-gray-50'
                    >
                ...
                <div className='grid grid-cols-2 divide-x divide-gray-950/5 bg-gray-50'>
      ...
      >
        ...
        <Dialog.Panel className='fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-[#013B94] px-6 py-6 sm:max-w-sm sm:ring1 sm:ring-gray-900/10'>
